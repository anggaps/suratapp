...
import { deleteIncomingLetter } from "@/lib/actions/incoming-letter.actions";

export function DeleteIncomingButton({ id }: { id: string }) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Tindakan ini tidak dapat dibatalkan. Semua lampiran terkait juga akan dihapus.
          </DialogDescription>
        </DialogHeader>
        <DialogFooter>
